...
unsafe fn public_window_callback_inner(
    ...
    let callback = || match msg {
        ...
        WM_DPICHANGED => {
            ...
            if dragging_window {
                // During an interactive cross-monitor drag, trust Windows'
                // WM_DPICHANGED rectangle directly. Recalculating it here can
                // create a mixed-DPI resize feedback loop.
